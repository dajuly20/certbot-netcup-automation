...
help:
	@echo -e "$(GREEN)Certbot-Netcup Automation - Makefile$(NC)"
	@echo -e ""
	@echo -e "$(GREEN)Main Commands:$(NC)"
	@echo -e "  $(YELLOW)make install$(NC)            - Full guided installation"
	@echo -e "  $(YELLOW)make renew-dryrun$(NC)       - Test: show what would be renewed"
	@echo -e "  $(YELLOW)make renew$(NC)              - Actually renew certificates now"
	@echo -e "  $(YELLOW)make status$(NC)             - Show service status & next run"
	@echo -e "  $(YELLOW)make logs$(NC)               - Show logs (add -f to follow)"
	@echo -e "  $(YELLOW)make check-expiry$(NC)       - Check certificate expiry dates"
	@echo -e ""
	@echo -e "$(GREEN)Configuration:$(NC)"
	@echo -e "  $(YELLOW)make setup-credentials$(NC)  - Reconfigure Netcup API credentials"
	@echo -e "  $(YELLOW)make edit-domains$(NC)       - Edit domains (or edit config.yaml)"
	@echo -e "  $(YELLOW)nano config.yaml$(NC)        - Edit all settings manually"
	@echo -e ""
	@echo -e "$(GREEN)Remote Sync:$(NC)"
	@echo -e "  $(YELLOW)make add-remote-host$(NC)    - Add a remote host for cert sync"
	@echo -e "  $(YELLOW)make list-remote-hosts$(NC)  - List configured remote hosts"
	@echo -e "  $(YELLOW)make sync-certs$(NC)         - Manually sync certs to remote hosts"
	@echo -e ""
	@echo -e "$(GREEN)Other:$(NC)"
	@echo -e "  $(YELLOW)make clean$(NC)              - Remove lock files"
	@echo -e "  $(YELLOW)make uninstall$(NC)          - Remove systemd configuration"
	@echo -e ""
	@echo -e "Quick start: $(GREEN)make install$(NC)"
